...
"""
forecast_csv_path = os.path.join(os.path.dirname(__file__), '..', 'model', 'VM', 'forecast', 'vm_forecasts.csv')
...
agent_input = {"data_summary": data_summary,"forecast_summary": forecast_summary}
